...
$_['entry_keyword']          = 'Đường dẫn thân thiện SEO:<br/>Ví dụ: Dien-thoai-Samsung-Galaxy-S3.html';
...
$_['entry_ean']              = 'EAN:<br/>European Article Number';

$_['entry_jan']              = 'JAN:<br/>Japanese Article Number';

$_['entry_isbn']             = 'ISBN:<br/>Mã sách theo chuẩn quốc tế';

$_['entry_mpn']              = 'MPN:<br/>Part Number theo nhà sản xuất';
...
$_['entry_minimum']          = 'Số lượng tối thiểu:<br/>Số lượng ít nhất khi đặt hàng';

$_['entry_stock_status']     = 'Hết hàng:<br/>Tình trạng hiện ra khi một sản phẩm hết hàng';
...
$_['entry_tag']              = 'Tags:<br />Ngăn cách bằng dấu phẩy';
...
$_['help_bookname']         = 'Tên sách:';
$_['help_author']           = 'Tác giả:';
$_['help_translator']       = 'Dịch giả:';
$_['help_isbn13']           = 'ISBN-13:';
$_['help_binding']          = 'Trình bày Bìa sách:';
$_['help_publishingdate']   = 'Ngày phát hành:';
$_['help_publisher']        = 'Nhà xuất bản:';
$_['help_numberofpages']    = 'Số trang:';
$_['help_booklanguage']         = 'Ngôn ngữ:';
$_['help_madein']         = 'Xuất xứ:';
$_['help_material']         = 'Chất liệu:';
