...
$_['entry_voucher_min']            = 'Minimum amount a customer can purchase a voucher for.';
$_['entry_voucher_max']            = 'Maximum amount a customer can purchase a voucher for.';
...
$_['entry_invoice_prefix']         = 'Invoice Prefix:<br />Set the invoice prefix (e.g. INV-2011-00). Invoice ID\'s will start at 1 for each unique prefix';
$_['entry_order_status']           = 'Order Status:<br />Set the default order status when an order is processed.';
...
$_['entry_mail_protocol']     = 'Giao thức Thư:<br /><span class="help">Chỉ chọn \'Thư\' trừ khi máy chủ lưu trữ của bạn đã bị vô hiệu hoá chức năng mail php</span>';
$_['entry_mail_parameter']    = 'Tham số thư <br />Khi sử dụng Mail, mail thông số bổ sung có thể được thêm ở đây (ví dụ -femail@storeaddress.com)';
...
$_['entry_fraud_score']         = 'Điểm số nguy hiểm MaxMind:<br />The higher the score the more likly the order is fraudulent. Set a score between 0 - 100.';
...
$_['entry_encryption']          = 'Encryption Key:<br />Xin vui lòng cung cấp một khóa bí mật sẽ được sử dụng để mã hóa thông tin cá nhân khi xử lý các đơn đặt hàng.';
$_['entry_compression']         = 'Kết quả mức nén:<br />Nén dữ liệu cho việc chuyển giao hiệu quả hơn cho các khách hàng yêu cầu. Mức độ nén phải có từ 0-9';
