        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-sort-description<?php echo $language['language_id']; ?>">Mô tả ngắn</label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][sort_description]" placeholder="<?php echo $entry_description; ?>" id="input-sort-description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['sort_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-sort-description<?php echo $language['language_id']; ?>">Sản phẩm bao gồm</label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][accessories]" placeholder="" id="input-accessories-description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['accessories'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-tag">Landing</label>
                    <div class="col-sm-10">
                        <select name="landing" class="form-control">
                            <option <?php if($landing==0) echo 'selected'; ?>   value="0">Tắt</option>
                            <option <?php if($landing==1) echo 'selected'; ?> value="1">Mở</option>
                        </select>
                    </div>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sku"><span>Bảo hành</span></label>
                <div class="col-sm-10">
                  <input type="text" name="guarantee" value="<?php echo $guarantee; ?>" placeholder="Bảo hành" id="input-sku" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sku"><span data-toggle="tooltip" title="<?php echo $help_sku; ?>"><?php echo $entry_sku; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="sku" value="<?php echo $entry_sku; ?>" placeholder="Bảo hành" id="input-sku" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-special">
              <div class="table-responsive">
                <table id="special" class="table table-striped table-bordered table-hover">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="gift<?php echo $language['language_id']; ?>">Quà tặng</label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][gift]" placeholder="Nhập quà tặng" id="gift<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['gift'] : ''; ?></textarea>
                    </div>
                  </div>
...
<?php } ?>
<?php foreach ($languages as $language) { ?>
$('#gift<?php echo $language['language_id']; ?>').summernote({height: 300});
<?php } ?>
<?php foreach ($languages as $language) { ?>
$('#input-sort-description<?php echo $language['language_id']; ?>').summernote({height: 300});
<?php } ?>
<?php foreach ($languages as $language) { ?>
$('#input-accessories-description<?php echo $language['language_id']; ?>').summernote({height: 300});
<?php } ?>
//--></script> 
  <script type="text/javascript"><!--
// Manufacturer
