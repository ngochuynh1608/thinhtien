...
<script type="text/javascript">
          ...
          if(!keyword.val()){
             $("input[name^='product_description'],input[name='name'],input[name^='information_description']").keyup(function(){
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img style="height:25px;" src="view/image/logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
