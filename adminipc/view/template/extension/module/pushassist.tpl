    ...
    <div class="col-md-6" style="<?php if(isset($account_response['account_name']) ){echo 'display:none';}?>">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form name="registration_form" id="registration_form" class="space-top" action="<?php echo $action;?>"
                          method="post">
...
<div class="form-group">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form name="key_form" id="key_form" class="space-top" action="<?php echo $action;?>"
                          method="post">
