...
class ControllerCheckoutCheckout extends Controller { 
	...
	{ 
		//echo $this->session->data['guest']['customer_group_id'];
		...
		if (!isset($this->session->data['guest']['customer_group_id'])) $this->session->data['guest']['customer_group_id'] = 1;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/checkout.tpl')) {
			$this->template  = $template =  $this->config->get('config_template') . '/template/checkout/checkout2.tpl';
		} else {
