...
$_['text_until_cancelled']   	= 'until cancelled';
$_['text_recurring_item']    	              = 'Recurring item';
$_['text_shipping_estimate'] = 'Phí vận chuyển ước tính &amp; Thuế';
$_['text_shipping_detail']   = 'Nhập điểm đến của bạn để có được một ước tính vận chuyển.';
$_['text_shipping_method']   = 'Xin vui lòng lựa chọn phương thức vận chuyển ưa thích cho đơn hàng này.';
...
$_['error_coupon']           = 'Cảnh báo: Mã giảm giá không tồn tại, đã quá hạn hoặc hết hiệu lực!';
$_['error_voucher']          = 'Cảnh báo: Phiếu voucher không hợp lệ hoặc không áp dụng tại mục này!';
$_['error_reward']           = 'Cảnh báo: Xin vui lòng nhập lượng điểm thưởng để sử dụng !';	
