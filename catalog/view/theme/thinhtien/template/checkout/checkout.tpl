		...
		<div class="row box checkout_form">
			...
			<div class="row">
			    ...
			    <?php if (isset($customer_id)) {?>	  
				  ...
				  <div class="form-group required col-md-6">
				    <label class="control-label" for="input-payment-zone"><?php echo $entry_city; ?></label>
			...
			<div class="shiptobilling clearfix">
			   ...
			   <?php //}?>
				...
				<div class="form-group required" style="display:none;">
				  ...
				  <div class="">
				    <input type="text" name="shipping_postcode" value="59000" placeholder="<?php echo str_replace(':','',$entry_postcode); ?>" id="input-shipping-postcode" class="form-control" />
				  </div>
				</div>
				<div class="form-group required" style="display:none;">
