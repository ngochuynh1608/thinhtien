...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (is_file(DIR_IMAGE . $this->config->get('config_logo'))) {
	       ...
	       $data['pushassist_jspath'] = $this->config->get('pushassist_jspath');
	       $data['pushassist_js_restrict'] = $this->config->get('pushassist_js_restrict');
        ...
        $data['xdch'] = $this->url->link('builder/product');
